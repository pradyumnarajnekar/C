...
int main()
{
    ...
    if(n>=1)
    {
        ...
        head_start->temporary3vious=head_start;
        ...
        for(i=2;i<=n;i++)
        {
            ...
            node1->temporary3vious=temporary1;
    ...
    head_start->temporary3vious=temporary1;
    temporary2->next=head_start;
    free(temporary3);
    n=1;
    temporary4=head_start;
    printf("\nAfter deletion from the front, the circular doubly linked list is : \n");
    do
    {
        printf(" <= %d =>",temporary4->data);
        temporary4=temporary4->next;
