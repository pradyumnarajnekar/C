...
int main()
{
    struct node *head_start, *node1, *new_node_at_end, *temporary1, *temporary2;
    ...
    printf("\nEnter the data for the node  to be inserted at end : ");
    ...
    new_node_at_end->next=head_start;
    new_node_at_end->previous=temporary1;
    head_start->previous=new_node_at_end;
    temporary1->next=new_node_at_end;
    temporary1=new_node_at_end;
    n=1;
    temporary2=head_start;
    printf("\nAfter insertion at end, the Circular Doubly Linked List is : \n");
    do
    {
        printf(" <= %d => ",temporary2->data);
        temporary2=temporary2->next;
